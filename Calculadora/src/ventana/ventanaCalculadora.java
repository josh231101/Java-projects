...
public class ventanaCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        convesorDivisas = new javax.swing.JMenuItem();
        ...
        botonResultado.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.weighty = 0.5;
        panel.add(botonResultado, gridBagConstraints);
        ...
        calculadoraEstandar.setText("Calcudora Estándar");
        ...
        convesorDivisas.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        convesorDivisas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/divisas.png"))); // NOI18N
        convesorDivisas.setText("Conversor de Divisas");
        convesorDivisas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                convesorDivisasActionPerformed(evt);
            }
        });
        menu.add(convesorDivisas);
    ...
    private void convesorDivisasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convesorDivisasActionPerformed
        // TODO add your handling code here:
        ventanaDivisas conversor = new ventanaDivisas();
        conversor.setVisible(true);
        
        dispose();//Cierra la ventan actual
    }//GEN-LAST:event_convesorDivisasActionPerformed
    ...
    private void botonDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDividirActionPerformed
       if(activadp== true){
            numero1 = Double.parseDouble(cadenaNumeros);//lO PARSEAMOS A UN DOUBLE
    ...
    private javax.swing.JMenuItem convesorDivisas;
